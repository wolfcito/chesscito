...
3. Load and execute the workflow configuration at {project-root}/_bmad/gds/workflows/1-preproduction/game-brief/workflow.yaml using the engine from step 2
