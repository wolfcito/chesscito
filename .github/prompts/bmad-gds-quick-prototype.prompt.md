...
3. Load and execute the workflow configuration at {project-root}/_bmad/gds/workflows/gds-quick-flow/quick-prototype/workflow.yaml using the engine from step 2
