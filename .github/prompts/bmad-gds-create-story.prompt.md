...
3. Load and execute the workflow configuration at {project-root}/_bmad/gds/workflows/4-production/create-story/workflow.yaml using the engine from step 2
