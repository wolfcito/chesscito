...
3. Load and execute the workflow configuration at {project-root}/_bmad/gds/workflows/3-technical/game-architecture/workflow.yaml using the engine from step 2
